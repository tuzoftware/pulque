...
class BaseRepository
{
    ...
    public function __constructorDB($db)
    {
        $this->db =$db;
        $this->filtros=array();
    }
	...
	protected function obtenerInstanciaIdValor($nombre_tabla,$id,$valor){
	...
	protected function convertirArregloModelo($nombreTabla,$arreglo){
        $objeto = null;
	...
	protected function guardarActualizar($arreglo,$nombre_tabla,$id){
		$objeto=null;
		if(empty($arreglo[$id])){
